...
type IFxManagerAddIn struct {
	arg0 string
	arg1 func() (gocommon.IApp, gocommon.ICancellationContext, error)
}
...
func CallIFxManagerAdd(context context.Context, channel chan<- interface{}, waitToComplete bool, arg0 string, arg1 func() (gocommon.IApp, gocommon.ICancellationContext, error)) (IFxManagerAddOut, error) {
